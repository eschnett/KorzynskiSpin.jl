...
\item the balanced round metric and horizon multipoles of Ashtekar, Khera,
  Kolanowski and Lewandowski \cite{ashtekar2022}, which use the same
  conformal decomposition.  Gourgoulhon, Le~Tiec and Casals
  \cite{glc2026} give the balanced conformal factor and the multipoles of
